      ...
      <section ref={aboutRef} className="bg-neutral-light py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-6 text-secondary-dark luxury-heading">A New Standard of Luxury</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            <div className="text-center p-6 bg-neutral-50 border border-primary/10 rounded-lg shadow-md specification-card"> {/* Added subtle border and bg-neutral-50 */}
              <div className="text-4xl font-serif font-bold text-primary mb-2 stat-value">306</div>
              <p className="stat-label text-gray-900 font-extrabold">Exclusive Apartments</p> {/* Added text-gray-900 and font-extrabold */}
            </div>
            <div className="text-center p-6 bg-neutral-50 border border-primary/10 rounded-lg shadow-md specification-card"> {/* Added subtle border and bg-neutral-50 */}
              <div className="text-4xl font-serif font-bold text-primary mb-2 stat-value">6.58</div>
              <p className="stat-label text-gray-900 font-extrabold">Acres of Property</p> {/* Added text-gray-900 and font-extrabold */}
            </div>
            <div className="text-center p-6 bg-neutral-50 border border-primary/10 rounded-lg shadow-md specification-card"> {/* Added subtle border and bg-neutral-50 */}
              <div className="text-4xl font-serif font-bold text-primary mb-2 stat-value">84%</div>
              <p className="stat-label text-gray-900 font-extrabold">Open & Green Area</p> {/* Added text-gray-900 and font-extrabold */}
            </div>
            <div className="text-center p-6 bg-neutral-50 border border-primary/10 rounded-lg shadow-md specification-card"> {/* Added subtle border and bg-neutral-50 */}
              <div className="text-4xl font-serif font-bold text-primary mb-2 stat-value">90%</div>
              <p className="stat-label text-gray-900 font-extrabold">Privacy Optimized</p> {/* Added text-gray-900 and font-extrabold */}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((item, index) => (
              ...
              >
                <div className="text-3xl mr-4 text-primary-dark">{item.icon}</div> {/* Changed to darker icon color */}
                <div>
                  <h3 className="font-bold text-lg mb-2 text-secondary-dark">{item.title}</h3> {/* Changed to secondary-dark for better contrast */}
                  <p className="text-gray-800 font-semibold">{item.description}</p> {/* Changed to text-gray-800 for better visibility */}
                </div>
              </div>
            ))}
          </div>
