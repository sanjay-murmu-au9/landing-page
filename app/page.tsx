          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.instagram.com/houseofdreamreality/" className="text-white hover:text-[#E4405F] transition-colors">
                ...
                <a href="https://x.com/HODreality" className="text-white hover:text-[#1DA1F2] transition-colors">
                  <span className="sr-only">Twitter</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                  </svg>
                </a>
                <a href="https://www.linkedin.com/in/houseofdreamreality-ilovebangalore-819462375/" className="text-white hover:text-[#0A66C2] transition-colors">
                ...
                <a href="https://www.youtube.com/@houseofdreamsreality" className="text-white hover:text-[#FF0000] transition-colors">
